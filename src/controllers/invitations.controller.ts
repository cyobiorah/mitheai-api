...
export const createInvitation = async (req: Request, res: Response) => {
  try {
    ...
    console.log("Full invitation data to be stored:", JSON.stringify(invitation, null, 2));
    ...
    try {
      ...
      console.log("Created invitation document data:", JSON.stringify(invitationDoc.data(), null, 2));
